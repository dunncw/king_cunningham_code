...
from scra_automation.scra import SCRAAutomationWorker
...
class SCRAAutomationUI(QWidget):
    ...
    def init_ui(self):
        ...
        # Title
        title_label = QLabel("SCRA Automation")
        ...
        # Start button
        self.start_button = QPushButton("Start SCRA Automation")
        ...
        warning_label = QLabel("WARNING: Automation in progress. Please do not interfere with the process.")
    ...
    def on_start_clicked(self):
        ...
        if excel_path and username and password and save_location:
            ...
            self.status_label.setText("SCRA Automation in progress...")
            self.spinner.show()
            self.warning_frame.show()
            
            # Create worker and thread
            self.thread = QThread()
            self.worker = SCRAAutomationWorker(excel_path, browser, username, password, save_location)
    ...
    def automation_finished(self):
        ...
        self.status_label.setText("SCRA Automation complete!")
        self.spinner.hide()
        self.warning_frame.hide()
